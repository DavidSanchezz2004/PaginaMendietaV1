    ...
    <div class="panel-body">
      <form id="empresaForm" class="form" method="POST" action="{{ route('equipo.empresas.store') }}" autocomplete="off">
        ...
        <div class="field">
          ...
          @error('departamento') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field">
          ...
          @error('provincia') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field">
          ...
          @error('distrito') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field">
          ...
          @error('direccion_fiscal') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field full">
          ...
          @error('notas_internas') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field">
          ...
          @error('estado_interno') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="field">
          ...
          @error('assigned_user_id') <div class="err">{{ $message }}</div> @enderror
        </div>
        ...
        {{-- opcional: si quieres ver errores de hidden (por si validas alguno) --}}
        @error('sunat_estado') <div class="err">{{ $message }}</div> @enderror
        @error('sunat_condicion') <div class="err">{{ $message }}</div> @enderror
        @error('ubigeo') <div class="err">{{ $message }}</div> @enderror
        @error('sunat_raw') <div class="err">{{ $message }}</div> @enderror
