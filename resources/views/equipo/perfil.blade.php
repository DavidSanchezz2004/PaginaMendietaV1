...
<div class="perfil-page">
  ...
  <div class="perfil-titlebar">
    ...
    <div class="perfil-actions">
      ...
      <button class="perfil-btn primary" type="button" disabled title="Próximamente">
        <svg viewBox="0 0 24 24" fill="none" stroke-width="2">
          <path d="M12 17v-2"></path>
          <path d="M8 11V8a4 4 0 0 1 8 0v3"></path>
          <path d="M6 11h12v10H6V11z"></path>
        </svg>
        Seguridad
      </button>
    </div>
    ...
    <div class="perfil-profile-row">
      ...
      <div class="perfil-pinfo">
        ...
        <div class="perfil-meta-row">
          ...
          <span class="perfil-mitem">
            {{ str_starts_with($u->rol, 'cliente') ? 'Acceso cliente' : 'Acceso interno' }}
          </span>

          <span class="sep">•</span>

          <span class="perfil-mitem">
            2FA {{ optional($u->mfa)->enabled ? 'activado' : 'pendiente' }}
          </span>
