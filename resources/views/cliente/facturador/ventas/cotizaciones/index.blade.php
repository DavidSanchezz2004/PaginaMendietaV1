...
<div class="index-container">
    ...
    <div class="index-header">
        <h1 class="index-title">
            <i data-lucide="file-check-2"></i> Cotizaciones
        </h1>
    ...
    <div class="filter-bar">
        <div class="search-input-wrapper" style="flex: 1; min-width: 250px; position: relative;">
            ...
            <input type="text" class="filter-input" placeholder="Buscar cotización, cliente..." style="width: 100%; padding-left: 32px;">
        </div>
    ...
    <div class="table-card">
        <table class="erp-table">
            ...
            <tbody>
                {{-- Mock Data Row 1 --}}
                <tr>
                    <td style="font-weight: 600; color: #64748b;">#COT-00052</td>
                    <td>12/02/2026</td>
                    <td><span style="color: #ea580c; font-weight: 600;">18/02/2026</span></td>
                    <td>
                        <div style="font-weight: 600; color: #0f172a;">MINERA YANACOCHA S.R.L.</div>
                        <div style="font-size: 11px; color: #94a3b8;">20133022135</div>
                    </td>
                    <td style="text-align: right; font-weight: 700;">$ 12,500.00</td>
                    ...
                    <td style="text-align: center;">
                        <button class="action-btn" title="Convertir a Venta"><i data-lucide="shopping-cart" style="width: 16px;"></i></button>
                 ...
                 {{-- Mock Data Row 2 --}}
                 <tr>
                    <td style="font-weight: 600; color: #64748b;">#COT-00051</td>
                    <td>11/02/2026</td>
                    <td>15/02/2026</td>
                    <td>
                        <div style="font-weight: 600; color: #0f172a;">DISTRIBUIDORA ACME</div>
                        <div style="font-size: 11px; color: #94a3b8;">20600112233</div>
                    </td>
                    <td style="text-align: right; font-weight: 700;">S/ 850.00</td>
                    <td style="text-align: center;">
                        <span class="status-badge status-ok">
                            <i data-lucide="check-circle" style="width: 12px; height: 12px;"></i> ACEPTADA
                        </span>
                    </td>
                    <td style="text-align: center;">
                        <button class="action-btn" title="Ver Venta"><i data-lucide="external-link" style="width: 16px;"></i></button>
                        <button class="action-btn" title="Descargar PDF"><i data-lucide="file-text" style="width: 16px;"></i></button>
                        <button class="action-btn" title="Más opciones"><i data-lucide="more-horizontal" style="width: 16px;"></i></button>
                    </td>
                </tr>
